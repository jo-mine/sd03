...
export default class SecondPage extends React.Component {
  pushPage() {
    this.props.navigator.pushPage({component: SecondPage, props: {value: this.props.value + 1, pankuzu: this.props.pankuzu + ">SecondPage"}});
  }
  ...
  render() {
    return (
      ...
      <p>{this.props.pankuzu + ">SecondPage"}</p>
